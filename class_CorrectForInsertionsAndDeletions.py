class CorrectForInsertionsAndDeletions:
    ...
    ## Identification and insertion of sequence blocks, missing from genome B relative to genome A, into genome B
    ...
    ## Identification and removal of sequence blocks, present in genome B relative to genome A, from genome B
